        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.span
              ...
              viewport={{ once: true }}
              className="inline-block px-4 py-2 border border-white/15 rounded-full text-sm font-medium mb-4 tracking-wide"
              style={{ color: '#9199A6' }}
            >
              Get to know me
            </motion.span>
          ...
          >
            <p className="text-xl mb-4" style={{ color: '#9199A6' }}>
          ...
          <div className="py-16 sm:py-20 border-t border-white/10">
            <h3 className="text-4xl sm:text-5xl font-bold text-white text-center mb-12 tracking-tight">
              Tech Arsenal
            </h3>
